...
class HistoryAdaptor(
    var context:Context,
    var historylist: ArrayList<HistoryResponse.Data>,
): RecyclerView.Adapter<HistoryAdaptor.ExerciseHodlder>() {
    ...
    override fun onBindViewHolder(holder: ExerciseHodlder, position: Int) {
        ...
        try {
            ...
            holder.distance.text=historylist[position].distance
    ...
    inner class ExerciseHodlder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            distance=itemView.findViewById(R.id.d_distance)
